                  ...
                  <div className="space-y-4">
                    <div className="flex justify-center mb-4">
                      {selectedEmployee?.profilePhotoUrl ? (
                        <Image src={selectedEmployee.profilePhotoUrl.startsWith('http') 
                          ? selectedEmployee.profilePhotoUrl 
                          : `${API_ORIGIN}${selectedEmployee.profilePhotoUrl}`}
                          alt={selectedEmployee.employeeName || 'Employee'} width={120} height={120} className="w-30 h-30 rounded-full object-cover" />
                      ) : (
